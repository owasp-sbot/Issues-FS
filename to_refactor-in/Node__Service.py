...
class Node__Service(Type_Safe):                                                  # Node business logic service
    ...
    root_selection_service : Root__Selection__Service = None                     # Phase 2 (B14/B17): Root context
    ...
    def resolve_hierarchical_path(self                     ,                     # Convert hierarchical to filesystem path
        ...
        if current_root:
            ...
            found_path  = self.repository.node_find_path_by_label(
                              Safe_Str__Node_Label(first_label))

            if found_path is None:
                return None

            result    = str(found_path)
            start_idx = 1
    ...
    @type_safe
    def get_node_by_hierarchical_path(self                     ,                 # Get node by hierarchical path
                                      path : str
